            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<a href="{{URL::action('AdminArtefactController@add')}}" class="add-btn btn btn-info btn-xs">
						...
						<table class="table table-striped">
						  ...
						  <tr>
							...
							<td>
								<a href="{{URL::action('AdminArtefactController@edit', array($entity->id))}}"> <i class="glyphicon glyphicon-edit"></i></a> 
								<a href="{{URL::action('AdminArtefactController@delete', array($entity->id))}}"> <i data-entity-id="{{$entity->id}}" class="delete-entity glyphicon glyphicon-trash"></i></a> 
							</td>
						  </tr>
						  @endforeach					  
						</table>
		...
		$(function(){
            ...
            $('.delete-entity').on('click', function(e){
                ...
                if(confirm('¿Desea eliminar el elemento? ')){
	                ...
	                var deleteURL = "<?= URL::to('/') . '/admin/artefacto/eliminar/'?>";
