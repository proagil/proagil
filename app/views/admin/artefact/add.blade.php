    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    	<h3><?=Config::get('constant.admin.action.add').' '.Config::get('constant.admin.entity.artefact')?></h3>
                        <p><button class="add-btn btn btn-info btn-xs" onclick="goBack()"><i class="glyphicon glyphicon-chevron-left"></i>Volver</button></p>

                        <?= Form::open(array('action' => 'AdminArtefactController@add', 'class' => 'form-horizontal', 'files' => true)) ?> 
                        <fieldset>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-4">
                                  <?=  Form::checkbox('values[enabled]', TRUE, FALSE);?> 
                              </div>
                            </div>
