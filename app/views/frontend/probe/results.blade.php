	                ...
	                <div class="col-lg-12">
						<div class="activities-content">
							<div class="breadcrumbs-content">
								Inicio  <span class="fc-green"> &raquo; </span> {{Session::get('project')['name']}}  <span class="fc-green"> &raquo; </span> {{$iteration['name']}}  <span class="fc-green"> &raquo; </span> {{$probeTitle}} <span class="fc-green"> &raquo; </span> Resultados
							</div>	
