                        ...
                        {{ Form::open(array('action' => array('ProjectController@invitation'), 'id' => 'form-send-invitations')) }}							
                          ...
                          <div class="invitation-content user-invitation-0">
                            <div class="form-group">
                              ...
                              <div class="col-md-8">
                                {{ Form::text('invitations[email][]', (isset($values['first_name']))?$values['first_name']:'', array('placeholder' => 'Correo electr&oacute;nico', 'class'=>'form-control app-input-invitation invitation-email app-input')) }}
