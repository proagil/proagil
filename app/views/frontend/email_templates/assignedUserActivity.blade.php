...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title> NOTIFICACIÓN DE ACTIVIDAD ASIGNADA </title>
		<style>
			/* -------------------------------------
				GLOBAL
			------------------------------------- */
					...
					<table>
						<tr>
							<td>
								...
								<p style="line-height: 1.6" ><strong style = "text-transform: capitalize">{{$user_name}}</strong> te ha asignado la actividad <strong style = "text-transform: capitalize">{{$activity_title}}</strong> perteneciente a la iteración <strong style = "text-transform: capitalize">{{$iteration_name}}</strong>.Para obtener más información haz clic en el siguiente botón:</p>
								<br>
								<i style="float: right">
